...
cmd({
  ...
  try {
    ...
    if (!_0x283a2f) {
      return await _0x20e232("*Example - :* .pair +255760XXXX");
    }
    await _0x20e232("*Getting pairing code...*");
    const _0x4504a8 = await fetchJson("https://subzeromd-pair-one.onrender.com/code?number=" + _0x283a2f);
    const _0x4bc4f7 = _0x4504a8.code;
    await _0x1cac84.reply('' + _0x4bc4f7);
    await _0x1cac84.reply("> *Use the above pairing code to get your session id for MATRIX-XMD.*");
  } catch (_0x978c45) {
...
cmd({
  ...
  try {
    ...
    if (!_0x648b91) {
      return await _0x205d46("*Example - :* .pair2 +255760XXXX");
    }
    ...
    await _0x33b7ac.reply("> *Use the above pairing code to get your session id for MATRIX-XMD.*");
  } catch (_0x4da84d) {
